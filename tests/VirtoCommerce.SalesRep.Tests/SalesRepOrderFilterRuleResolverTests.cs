...
/// <summary>
/// Pure-logic tests for the default <see cref="SalesRepOrderFilterRuleResolver"/> — each configured Order.Status value
...
{
    private static SalesRepOrderFilterRuleResolver CreateService(params string[] configuredStatuses) =>
