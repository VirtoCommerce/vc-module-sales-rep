...
export class CustomerModuleClient extends AuthApiBase {
    ...
    getMemberById(id: string, responseGroup?: string | undefined, memberType?: string | undefined): Promise<Member> {
        ...
        if (memberType === null)
            throw new globalThis.Error("The parameter 'memberType' cannot be null.");
    ...
    getMembersByIds(ids?: string[] | undefined, responseGroup?: string | undefined, memberTypes?: string[] | undefined): Promise<Member[]> {
        ...
        if (responseGroup === null)
            ...
            url_ += "responseGroup=" + encodeURIComponent("" + responseGroup) + "&";
        if (memberTypes === null)
            throw new globalThis.Error("The parameter 'memberTypes' cannot be null.");
...
export class OrganizationMembershipClient extends AuthApiBase {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    ...
    /**
     * Returns the count of organization memberships for a user (lightweight — for widget counters).
     * @return OK
     */
    countByUserId(userId: string): Promise<void> {
        let url_ = this.baseUrl + "/api/customer/organization-memberships/user/{userId}/count";
        if (userId === undefined || userId === null)
            throw new globalThis.Error("The parameter 'userId' must be defined.");
        url_ = url_.replace("{userId}", encodeURIComponent("" + userId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processCountByUserId(_response);
        });
    }

    protected processCountByUserId(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    /**
     * Returns paginated organization memberships.
     * @param body (optional) 
     * @return OK
     */
    search(body?: OrganizationMembershipSearchCriteria | undefined): Promise<OrganizationMembershipSearchResult> {
        let url_ = this.baseUrl + "/api/customer/organization-memberships/search";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processSearch(response: Response): Promise<OrganizationMembershipSearchResult> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as OrganizationMembershipSearchResult;
            return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<OrganizationMembershipSearchResult>(null as any);
    }

    /**
     * Returns the membership record for a specific user/organization pair.
     * @return OK
     */
    getByUserAndOrg(userId: string, organizationId: string): Promise<OrganizationMembership> {
        let url_ = this.baseUrl + "/api/customer/organization-memberships/user/{userId}/org/{organizationId}";
        if (userId === undefined || userId === null)
            throw new globalThis.Error("The parameter 'userId' must be defined.");
        url_ = url_.replace("{userId}", encodeURIComponent("" + userId));
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetByUserAndOrg(_response);
        });
    }

    protected processGetByUserAndOrg(response: Response): Promise<OrganizationMembership> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as OrganizationMembership;
            return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<OrganizationMembership>(null as any);
    }
     ...
     * @return OK
     */
    getById(id: string): Promise<OrganizationMembership> {
        let url_ = this.baseUrl + "/api/customer/organization-memberships/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetById(response: Response): Promise<OrganizationMembership> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    update(id: string, body?: OrganizationMembership | undefined): Promise<OrganizationMembership> {
        let url_ = this.baseUrl + "/api/customer/organization-memberships/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processUpdate(response: Response): Promise<OrganizationMembership> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    create(body?: OrganizationMembership | undefined): Promise<OrganizationMembership> {
        let url_ = this.baseUrl + "/api/customer/organization-memberships";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: Response): Promise<OrganizationMembership> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    /**
     * Deletes organization memberships by IDs.
     * @param ids (optional) 
     * @return No Content
     */
    delete(ids?: string[] | undefined): Promise<void> {
    ...
    /**
     * Locks a membership — user cannot sign in to this organization.
     * @param body (optional) 
     * @return OK
     */
    lock(id: string, body?: LockMembershipRequest | undefined): Promise<OrganizationMembership> {
        let url_ = this.baseUrl + "/api/customer/organization-memberships/{id}/lock";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processLock(response: Response): Promise<OrganizationMembership> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    /**
     * Unlocks a membership.
     * @return OK
     */
    unlock(id: string): Promise<OrganizationMembership> {
        let url_ = this.baseUrl + "/api/customer/organization-memberships/{id}/unlock";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUnlock(response: Response): Promise<OrganizationMembership> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export interface LockMembershipRequest {
    lockoutEnd?: Date | undefined;
}
