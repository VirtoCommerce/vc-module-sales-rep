...
export class AppManifestClient extends AuthApiBase {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    ...
    getManifest(appId: string): Promise<AppManifestResponse> {
        let url_ = this.baseUrl + "/api/apps/{appId}/manifest";
    ...
    protected processGetManifest(response: Response): Promise<AppManifestResponse> {
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as AppManifestResponse;
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<AppManifestResponse>(null as any);
    }
    ...
    invalidateManifestCache(): Promise<void> {
        let url_ = this.baseUrl + "/api/apps/manifest/invalidate";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processInvalidateManifestCache(_response);
        });
    }
...
export class ChangeLogClient extends AuthApiBase {
    ...
    searchChangesV2(body?: ChangeLogSearchCriteria | undefined): Promise<ChangeLogSearchResult> {
        let url_ = this.baseUrl + "/api/platform/changelog/v2/search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processSearchChangesV2(_response);
        });
    }
...
export class ModulesClient extends AuthApiBase {
    ...
    installModuleRequests(body?: ModuleInstallRequest[] | undefined): Promise<ModulePushNotification> {
        let url_ = this.baseUrl + "/api/platform/modules/install/v2";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processInstallModuleRequests(_response);
        });
    }
    ...
    updateModuleRequests(body?: ModuleInstallRequest[] | undefined): Promise<ModulePushNotification> {
        let url_ = this.baseUrl + "/api/platform/modules/update/v2";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processUpdateModuleRequests(_response);
        });
    }
    ...
    uninstallModuleRequests(body?: ModuleInstallRequest[] | undefined): Promise<ModulePushNotification> {
        let url_ = this.baseUrl + "/api/platform/modules/uninstall/v2";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processUninstallModuleRequests(_response);
        });
    }
    ...
    validateModuleVersion(moduleId: string, version: string): Promise<boolean> {
        let url_ = this.baseUrl + "/api/platform/modules/{moduleId}/versions/{version}/validate";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processValidateModuleVersion(_response);
        });
    }
    ...
    installModuleVersion(moduleId: string, version: string): Promise<ModulePushNotification> {
        let url_ = this.baseUrl + "/api/platform/modules/{moduleId}/versions/{version}/install";
        if (moduleId === undefined || moduleId === null)
            throw new globalThis.Error("The parameter 'moduleId' must be defined.");
        url_ = url_.replace("{moduleId}", encodeURIComponent("" + moduleId));
        if (version === undefined || version === null)
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processInstallModuleVersion(_response);
        });
    }
    ...
    installModule(moduleId: string): Promise<ModulePushNotification> {
        let url_ = this.baseUrl + "/api/platform/modules/{moduleId}/install";
        if (moduleId === undefined || moduleId === null)
            throw new globalThis.Error("The parameter 'moduleId' must be defined.");
        url_ = url_.replace("{moduleId}", encodeURIComponent("" + moduleId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processInstallModule(_response);
        });
    }
    ...
    uninstallSingleModule(moduleId: string): Promise<ModulePushNotification> {
        let url_ = this.baseUrl + "/api/platform/modules/{moduleId}/uninstall";
        if (moduleId === undefined || moduleId === null)
            throw new globalThis.Error("The parameter 'moduleId' must be defined.");
        url_ = url_.replace("{moduleId}", encodeURIComponent("" + moduleId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processUninstallSingleModule(_response);
        });
    }
...
export class SecurityClient extends AuthApiBase {
    ...
    getUsersByIds(ids?: string[] | undefined): Promise<ApplicationUser[]> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetUsersByIds(_response);
        });
    }
...
export class SettingsV2Client extends AuthApiBase {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    ...
    getGlobalSchema(moduleId?: string | undefined, keyword?: string | undefined): Promise<SettingPropertySchema[]> {
        let url_ = this.baseUrl + "/api/platform/settings/v2/global/schema?";
        if (moduleId === null)
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetGlobalSchema(_response);
        });
    }
    ...
    protected processGetGlobalSchema(response: Response): Promise<SettingPropertySchema[]> {
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as SettingPropertySchema[];
            return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<SettingPropertySchema[]>(null as any);
    }
    ...
    getGlobalValues(modifiedOnly?: boolean | undefined, moduleId?: string | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/platform/settings/v2/global/values?";
        if (modifiedOnly === null)
            throw new globalThis.Error("The parameter 'modifiedOnly' cannot be null.");
        else if (modifiedOnly !== undefined)
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetGlobalValues(_response);
        });
    }
     ...
     * @return No Content
     */
    saveGlobalValues(replaceAll?: boolean | undefined, body?: { [key: string]: any; } | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/platform/settings/v2/global/values?";
        if (replaceAll === null)
            throw new globalThis.Error("The parameter 'replaceAll' cannot be null.");
        else if (replaceAll !== undefined)
            url_ += "replaceAll=" + encodeURIComponent("" + replaceAll) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processSaveGlobalValues(_response);
        });
    }
    ...
    getTenantSchema(tenantType: string, moduleId?: string | undefined, keyword?: string | undefined): Promise<SettingPropertySchema[]> {
        let url_ = this.baseUrl + "/api/platform/settings/v2/tenant/{tenantType}/schema?";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetTenantSchema(_response);
        });
    }
    ...
    getTenantValues(tenantType: string, tenantId: string, modifiedOnly?: boolean | undefined, moduleId?: string | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/platform/settings/v2/tenant/{tenantType}/{tenantId}/values?";
        if (tenantType === undefined || tenantType === null)
            throw new globalThis.Error("The parameter 'tenantType' must be defined.");
        url_ = url_.replace("{tenantType}", encodeURIComponent("" + tenantType));
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetTenantValues(_response);
        });
    }
     ...
     * @return No Content
     */
    saveTenantValues(tenantType: string, tenantId: string, replaceAll?: boolean | undefined, body?: { [key: string]: any; } | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/platform/settings/v2/tenant/{tenantType}/{tenantId}/values?";
        if (tenantType === undefined || tenantType === null)
            throw new globalThis.Error("The parameter 'tenantType' must be defined.");
        url_ = url_.replace("{tenantType}", encodeURIComponent("" + tenantType));
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processSaveTenantValues(_response);
        });
    }
    ...
    getMeSchema(moduleId?: string | undefined, keyword?: string | undefined): Promise<SettingPropertySchema[]> {
        let url_ = this.baseUrl + "/api/platform/settings/v2/me/schema?";
        if (moduleId === null)
            throw new globalThis.Error("The parameter 'moduleId' cannot be null.");
        else if (moduleId !== undefined)
            url_ += "moduleId=" + encodeURIComponent("" + moduleId) + "&";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetMeSchema(_response);
        });
    }
    ...
    getMeValues(modifiedOnly?: boolean | undefined, moduleId?: string | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/platform/settings/v2/me/values?";
        if (modifiedOnly === null)
            throw new globalThis.Error("The parameter 'modifiedOnly' cannot be null.");
        else if (modifiedOnly !== undefined)
            url_ += "modifiedOnly=" + encodeURIComponent("" + modifiedOnly) + "&";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetMeValues(_response);
        });
    }
     ...
     * @return No Content
     */
    saveMeValues(replaceAll?: boolean | undefined, body?: { [key: string]: any; } | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/platform/settings/v2/me/values?";
        if (replaceAll === null)
            throw new globalThis.Error("The parameter 'replaceAll' cannot be null.");
        else if (replaceAll !== undefined)
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processSaveMeValues(_response);
        });
    }
