...
//
// vue-i18n's own factory is enough here: the host's CLDR plural rule defers to vue-i18n's default
// for messages with fewer than four forms, and every message below has three.
