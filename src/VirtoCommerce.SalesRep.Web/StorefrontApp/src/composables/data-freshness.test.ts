...
// The spec needs *an* Apollo cache, not the host's instance — the policies it exercises are the
// module's own, and a plugin has no access to the host's cache object anyway.
