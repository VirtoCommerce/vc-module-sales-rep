...
public class SalesRepTaskSortRule : IFieldSortRule
{
    ...
    public static SalesRepTaskSortRule Create(string name, string localizedName, string sortField, SortDirection defaultDirection, bool supportsDirection)
    {
        var result = AbstractTypeFactory<SalesRepTaskSortRule>.TryCreateInstance();
        result.Name = name;
