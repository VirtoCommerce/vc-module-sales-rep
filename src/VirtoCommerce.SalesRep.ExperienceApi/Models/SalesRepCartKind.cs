...
/// <see cref="SalesRepOrderStatus"/>, but richer: a kind is a composite filter over cart <see cref="Types"/> and/or
...
public class SalesRepCartKind : INamedFilterRule
{
    ...
    public static SalesRepCartKind Create(string name, string localizedName, string[] types = null, string[] statuses = null)
    {
        var result = AbstractTypeFactory<SalesRepCartKind>.TryCreateInstance();
        result.Name = name;
