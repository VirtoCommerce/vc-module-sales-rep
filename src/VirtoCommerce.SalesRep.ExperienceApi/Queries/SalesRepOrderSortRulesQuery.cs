...
/// <summary>
/// Returns the selectable Sales Rep orders-list orderings (VCST-5309). The selected rule's <c>name</c> is sent back
/// as the <c>salesRepOrders</c> "sort" argument. Store configuration, not rep-scoped data.
/// </summary>
