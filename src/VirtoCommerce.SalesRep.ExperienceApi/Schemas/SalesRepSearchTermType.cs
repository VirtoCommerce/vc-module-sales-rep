...
public class SalesRepSearchTermType : ExtendableGraphType<SalesRepSearchTerm>
{
    public SalesRepSearchTermType()
    {
        ...
        Field(x => x.LastSearchedDate, nullable: true).Description("Latest tracked search, as the UTC start of an analytics hour bucket; null under sort 'count' — the aggregate rows carry no dates.");
    }
}
